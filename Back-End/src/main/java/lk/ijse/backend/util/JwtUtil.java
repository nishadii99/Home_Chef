...
public class JwtUtil implements Serializable {
    private static final long serialVersionUID = 1582033471981586515L;

    // 30 days validity (in seconds)
    public static final long JWT_TOKEN_VALIDITY = 2592000L;
    ...
    private String doGenerateToken(Map<String, Object> claims, String subject) {
        return Jwts.builder()
                ...
                .setExpiration(new Date(System.currentTimeMillis() + JWT_TOKEN_VALIDITY * 1000)) // 30 days
